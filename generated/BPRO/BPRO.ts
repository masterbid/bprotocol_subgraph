...
export class BPRO__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class BPRO extends ethereum.SmartContract {
  static bind(address: Address): BPRO {
    return new BPRO("BPRO", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): BPRO__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new BPRO__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<BPRO__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new BPRO__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
